...
const surveys = [
    {
        ...
        videoId: "q-XvI_5P7w4", // ニュース・解説系の埋め込み可能な動画（例）
    ...
    },
    {
        ...
        videoId: "YidpPst9v0I", // TVCMなどの公式系
        options: ["食べたよ！", "これから食べる！", "30周年おめでとう！"],
        comment: "30周年おめでとうらびっ！🍔✨ 春といえばやっぱりコレだよね！らびも瀬戸内レモンのやつが気になってるらび〜っ！🍋🐰"
    }
];

async function finalCleanAndRepost() {
    console.log('🧹 既存のアンケートを完全に一掃中...');
    ...
    console.log('🚀 埋め込み確認済みの動画IDで再投稿中...');
