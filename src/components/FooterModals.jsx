          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <ul>
                ...
                <li><strong>データの自動削除：</strong> 当サイトでは鮮度の高い情報を保つため、終了したアンケートデータは締切後一定期間（原則7日）で自動的に完全削除されます。</li>
              </ul>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <ul>
                ...
                <li><strong>コミュニティの鮮度：</strong> 終了したアンケートを自動削除する仕組みにより、常に最新かつ有益な情報が集まる広場としての環境を維持しています。</li>
